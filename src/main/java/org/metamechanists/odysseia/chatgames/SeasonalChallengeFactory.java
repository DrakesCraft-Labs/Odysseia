...
final class SeasonalChallengeFactory {
     ...
     *
     * Ninguna respuesta lleva barra. Escribir "/menu" en el chat ejecuta el comando y el evento de
     * chat no llega nunca, asi que quien sabia la respuesta perdia la ronda igual. Cuando la
     * respuesta es un comando, el enunciado avisa "(sin barra)" y la explicacion final si la
     * muestra con barra para que el jugador aprenda a usarla.
     */
    private static final List<String[]> TRIVIA = List.of(
            new String[]{"Que comando abre el menu principal del servidor? (sin barra)", "menu", "El menu principal se abre con /menu."},
            new String[]{"Que dos palabras van despues de la barra para abrir la guia de Slimefun?", "sf guide", "La guia se abre con /sf guide."},
            ...
            new String[]{"Que comando abre el menu de modalidades? (sin barra)", "modalidades", "Con /modalidades saltas entre las modalidades del servidor."},
            new String[]{"Que comando te devuelve al lobby? (sin barra)", "lobby", "El /lobby te lleva al hub para elegir modalidad."},
            ...
            new String[]{"Que comando abre tu isla de SkyBlock? (sin barra)", "is", "La isla de SkyBlock se abre con /is. La de OneBlock es /ob."},
            new String[]{"Que comando te lleva lejos a empezar una base? (sin barra)", "rtp", "El /rtp te suelta lejos del spawn para que construyas tranquilo."},
            new String[]{"Que comando abre tus bovedas personales? (sin barra)", "pv", "Las bovedas van por modalidad: lo que guardas en una no aparece en otra."},
            ...
            new String[]{"Que comando abre la subasta entre jugadores? (sin barra)", "ah", "En /ah pones tus cosas al precio que quieras."},
